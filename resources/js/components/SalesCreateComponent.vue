    ...
    <div class="row">
        <div class="col-md-12">
            <form role="form" @submit.prevent="payment()" method="post" class="row" autocomplete="off">
                ...
                <div class="form-group col-md-4">
                    <label for="mokam_name">Mokam <span class="text-danger">*</span></label>
                    <input type="text" name="mokam_name" class="form-control" id="mokam_name" v-model="customer.mokam.mokam_name" readonly>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="driver_id" v-model="driver_id" class="form-control" id="driver_id" required>
                        <option value="" disabled selected>Select One</option>
                        <option :value="driver.id" v-for="driver in drivers">{{ driver.driver_name }} - {{ driver.mobile_no }}</option>
                    </select>
                </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            get_customers(){
                axios.get(baseURL + '/admin/sales/published-customers')
                    .then(response => {
            ...
            customer_info(event){
                ...
                axios.get(baseURL + '/admin/sales/customer-info/' + id)
                    .then(response => {
            ...
            get_products(){
                axios.get(baseURL + '/admin/productions/stock-products')
                    .then(response => {
            ...
            product_info(event, i){
                const id = event.target.value
                axios.get(baseURL + '/admin/sales/product-info/' + id)
                    .then(response => {
            ...
            calculate_subtotal(i){
                axios.post(baseURL + '/admin/sales/calculate-subtotal',{
            ...
            payment(){
                axios.post(baseURL + '/admin/sales/payment',{
                    items: this.items,
                ...
                .then(response => {
                    ...
                    window.location.href = baseURL + '/admin/sales/invoice/show/' + response.data.id
                })
                .catch(errors => {
