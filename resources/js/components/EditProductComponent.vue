    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form @submit.prevent="updateProduct()" autocomplete="off">
                ...
                <div class="form-group">
                    <label>Unit Price <span class="text-primary">(Per {{ unit_price_label }})</span><span
...
<script>
    export default {
        ...
        methods: {
            updateProduct() {
                this.form.put(baseURL + '/admin/productions/finished-products/' + this.form.id)
                    .then(response => {
            ...
            product_info() {
                axios.get(baseURL + '/admin/productions/finished-product-info/' + this.product_id)
                    .then(response => {
                        this.form.reset();
