        ...
        <div class="col-md-12">
            <form role="form" @submit.prevent="payment()" method="post" class="row" autocomplete="off">
                <div class="form-group col-md-3">
                    ...
                    <select name="supplier_id" v-model="supplier_id" class="form-control" id="supplier_id" @change="supplier_info($event)" required>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="business_name" class="form-control" id="business_name" v-model="supplier.business_name" readonly>
                </div>

                <div class="form-group col-md-3">
                    <label for="mobile">Mobile No <span class="text-danger">*</span></label>
                    <input type="text" name="mobile" class="form-control" id="mobile" v-model="supplier.mobile" readonly>
                </div>

                <div class="form-group col-md-3">
                    <label for="due">Previous Due <span class="text-danger">*</span></label>
                    <div class="input-group">
                        <input type="number" step="any" name="due" class="form-control" id="due" v-model="supplier.due" readonly>
                ...
                <div class="col-md-12 mt-3">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th width="15%" class="text-right">Purchase Price</th>
                        ...
                        <!--<tr>
                            <td colspan="5" class="text-right"><strong>Labour Cost</strong></td>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="5" class="text-right"><strong>Note</strong></td>
                            <td colspan="2">
                                <textarea name="details" class="form-control" id="details" v-model="details" placeholder="Entry note"></textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<script>
    export default {
        ...
        methods: {
            ...
            get_suppliers(){
                axios.get(baseURL + '/admin/suppliers/published_suppliers')
                    .then(response => {
            ...
            supplier_info(event){
                ...
                axios.get(baseURL + '/admin/suppliers/supplier-info/' + id)
                    .then(response => {
            ...
            product_info(event, i){
                const id = event.target.value
                axios.get(baseURL + '/admin/suppliers/product-info/' + id)
                    .then(response => {
            ...
            calculate_subtotal(i){
                axios.post(baseURL + '/admin/suppliers/calculate-subtotal',{
            ...
            payment(){
                axios.post(baseURL + '/admin/suppliers/payment',{
                    items: this.items,
                ...
                .then(response => {
                    ...
                    window.location.href = baseURL + '/admin/suppliers/purchase/show/' + response.data.id
                })
                .catch(errors => {
