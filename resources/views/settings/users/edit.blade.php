                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <form name="user-edit-form" role="form" action="{{ route('admin.settings.users.update', $user->id) }}" method="post">
                                        @csrf
                                        @method('PATCH')
...
@push('script')
    <script type="text/javascript">
        document.forms['user-edit-form'].elements['role_id'].value = "{{ $user->role_id }}";
    </script>
@endpush
