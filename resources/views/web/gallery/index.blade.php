                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0"> Manage Gallerys </h3>
                            ...
                            <div class="card-tools">
                                <form class="form-inline">
                                    ...
                                    <a class="btn btn-primary btn-sm mr-2" href="{{ route('admin.web.gallery.create') }}"><i class="fa fa-plus"></i> Add Gallerys</a>
                                </form>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <div id="printable_area">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.web.gallery.edit' , $gallery->id) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
