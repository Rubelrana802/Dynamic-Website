                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <form role="form" action="{{ route('admin.web.slider.update', $slider->id) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                        @csrf
                                        @method('PATCH')
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title" value="{{ $slider->title }}" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Enter title">
                                                         @error('title')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file">                                                          
                                                            ...
                                                            <img height="100px" src="{{ asset('web/image/slider/'.$slider->image )}}" alt="talukder" class="img-fluid mt-2">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <textarea rows="3" name="details" class="form-control @error('details') is-invalid @enderror" placeholder="Write here...">{{ $slider->details }}</textarea>
                                                     @error('details')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
