            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.web.subscribe.index') }}">Website</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title mb-0"> Manage Subscriber </h3>
                        ...
                        <div id="printable_area">
                            <table class="table table-hover">
                                ...
                                <tbody id="tbody">
                                @foreach($subscribers as $index => $contact)
                                <tr>
                                    <td>{{ ++$index}}</td>
                                    <td>{{ $contact->email }}</td>
